...
function Sidebar() {
  ...
  return (
    <div
      ...
      } md:h-[100vh] w-full md:w-[18%] shadow-lg`}
    >
      <div className="flex flex-col gap-4 md:gap-8 items-center mr-2 w-full md:hidden">
        ...
        <select className="w-[90%] mt-2 md:w-[12rem] text-xl border-[1px] border-gray-300 rounded-lg p-2">
          <option value="UtkarshDhairyapanwar">Utkarsh Dhairya panwar</option>
          <option value="Amartya Jha">Amartya Jha</option>
          <option value="Chinmay Bharti">Chinmay Bharti</option>
  ...
  return (
    <NavLink
      ...
      className={({ isActive }: { isActive: boolean }) =>
       ...
       gap-4 p-2 rounded-lg cursor-pointer hover:bg-[#1263d5]`
          : `border-0 flex flex-row items-center justify-start pl-5 pr-8
        bg-white text-black
       gap-4 p-2 rounded-lg cursor-pointer hover:bg-gray-100`
      }
    >
