  ...
  return (
    <div className="bg-[#fafafa] md:flex md:flex-row md:justify-center md:items-center h-[100vh] border-[1px] border-[#f3f2f2]">
      ...
      <div className="flex flex-col items-center justify-center h-[100vh] gap-2 md:w-[50%] w-full">
        <div className="bg-white h-[32rem] md:h-[35rem] rounded-md flex flex-col items-center w-[22rem] md:w-max pt-8 gap-8 border-[1px] border-[#f3f2f2]">
          <div className="flex flex-row items-center justify-center font-[inter] text-3xl font-light gap-2 mt-2">
            <img src="/Group 37110.png" alt="" />
            <p>CodeAnt AI</p>
          </div>
          ...
          <div className="flex flex-row gap-2 items-center md:p-4">
            <NavLink
              to="/auth/saas"
              className="bg-[#fafafa] text-black text-center text-xl p-2 w-[10rem] md:w-[15rem] rounded-md transition-all duration-300 hover:bg-[#1470ef] hover:text-white"
            >
              SAAS
            </NavLink>
...
function Options({
  ...
  return (
    <NavLink
      to={onClick}
      className="flex flex-row justify-center items-center font-semibold border-[1px] w-[20rem] md:w-[25rem] border-[#e5e4e4] gap-4 p-2 rounded-lg cursor-pointer transition-all duration-300 hover:bg-[#1470ef] hover:text-white"
    >
      <img src={img} alt="" />
      <p>{text}</p>
    </NavLink>
